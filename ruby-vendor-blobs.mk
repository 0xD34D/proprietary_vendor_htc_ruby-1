...
PRODUCT_COPY_FILES += \
    ...
    vendor/htc/ruby/proprietary/bluetooth.ko:system/lib/modules/bluetooth.ko \
    vendor/htc/ruby/proprietary/bnep.ko:system/lib/modules/bnep.ko \
    vendor/htc/ruby/proprietary/btwilink.ko:system/lib/modules/btwilink.ko \
    vendor/htc/ruby/proprietary/cfg80211.ko:system/lib/modules/cfg80211.ko \
    vendor/htc/ruby/proprietary/compat.ko:system/lib/modules/compat.ko \
    vendor/htc/ruby/proprietary/fm_drv.ko:system/lib/modules/fm_drv.ko \
    vendor/htc/ruby/proprietary/hid-magicmouse.ko:system/lib/modules/hid-magicmouse.ko \
    vendor/htc/ruby/proprietary/hidp.ko:system/lib/modules/hidp.ko \
    vendor/htc/ruby/proprietary/mac80211.ko:system/lib/modules/mac80211.ko \
    vendor/htc/ruby/proprietary/rfcomm.ko:system/lib/modules/rfcomm.ko \
    vendor/htc/ruby/proprietary/wl12xx.ko:system/lib/modules/wl12xx.ko \
    vendor/htc/ruby/proprietary/wl12xx_sdio.ko:system/lib/modules/wl12xx_sdio.ko 
...
# Camera
PRODUCT_COPY_FILES += \
    vendor/htc/ruby/proprietary/camera.default.so:system/lib/hw/camera.default.so \
    ...
    vendor/htc/ruby/proprietary/libCamera_gingerbread.so:system/lib/libCamera_gingerbread.so \
    vendor/htc/ruby/proprietary/libCamera_honeycomb.so:system/lib/libCamera_honeycomb.so \
    vendor/htc/ruby/proprietary/libCamera_ics.so:system/lib/libCamera_ics.so \
    vendor/htc/ruby/proprietary/libcamerapp.so:system/lib/libcamerapp.so \
    vendor/htc/ruby/proprietary/libcameraservice.so:system/lib/libcameraservice.so \
...
#    vendor/htc/ruby/proprietary/etc/init.goldfish.sh:system/etc/init.goldfish.sh \
#    vendor/htc/ruby/proprietary/etc/init.qcom.bt.sh:system/etc/init.qcom.bt.sh \
#    vendor/htc/ruby/proprietary/etc/init.qcom.coex.sh:system/etc/init.qcom.coex.sh \
#    vendor/htc/ruby/proprietary/etc/init.qcom.fm.sh:system/etc/init.qcom.fm.sh \
#    vendor/htc/ruby/proprietary/etc/init.qcom.post_boot.sh:system/etc/init.qcom.post_boot.sh \
#    vendor/htc/ruby/proprietary/etc/init.qcom.sdio.sh:system/etc/init.qcom.sdio.sh \
#    vendor/htc/ruby/proprietary/etc/init.qcom.wifi.sh:system/etc/init.qcom.wifi.sh 
